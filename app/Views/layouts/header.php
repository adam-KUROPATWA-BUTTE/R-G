...
} elseif (class_exists('\Models\Cart')) {
...
<head>
    ...
    <link rel="stylesheet" href="<?= $base_path ?>/public/styles/auth.css">
    ...
    <nav class="navbar">
        <div class="nav-container">
            ...
            <div class="logo-container">
                <a href="<?= $base_path ?>/">
                    <img src="<?= $base_path ?>/public/assets/logo.png" alt="R&G Logo" class="logo">
                </a>
            </div>
